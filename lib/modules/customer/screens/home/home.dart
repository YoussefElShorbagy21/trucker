...
class HomeScreen extends StatelessWidget {
  ...
  List<String> image = [
    ...
    "https://i0.wp.com/blog.ritchiebros.com/wp-content/uploads/2022/04/Wheel-loader-for-sale-Ritchie-Bros.jpg?fit=800%2C445&ssl=1",
    "https://img.forconstructionpros.com/files/base/acbm/fcp/image/2023/03/XCMG_XCA150_U.641cab35c2b8b.png?auto=format%2Ccompress&q=70",
    ...
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2NFTqQwRbhOgbcT9L2ld0rk2Byb64f0xUug&usqp=CAU",
                          ...
                          Row(
                            children: [
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  'view_all(${cubit.homeModel.results.toString()})',
                                  style: const TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                  ),
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => DetailsCategoryScreen(data.equipment[reverse].id)));
              },
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Card(
            ...
            return GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => CategoryScreen(title[index])));
                },
  ...
  Widget buildCategory(BuildContext context, String text, String img) =>
      Padding(
        padding: const EdgeInsets.all(8.0),
        child: Column(
          children: [
