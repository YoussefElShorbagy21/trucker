...
import '../../../../shared/resources/select_photo_options_screen.dart';
  ...
  class NewPostScreen extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      ...
      {
        print(HomeCubit.get(context).governmentController.text);
        print(HomeCubit.get(context).categoryController.text);
        return Scaffold(
          appBar: AppBar(
                ...
                child: OutlinedButton(
                  onPressed: () {
                      HomeCubit.get(context).postNewEquipment(
                          ...
                          government: HomeCubit.get(context).governmentController.text, userId: uid);
