                                ...
                                child: Column(
                                  children: [
                                      ...
                                      onFieldSubmitted: (value)
                                      {
                                        if(formKey1.currentState!.validate())
                                        {
                                          RegisterCubit.get(context).userSignup(
                                              ...
                                              confirmPassword: confirmPasswordControllerS.text,
                                              phone: phoneControllerS.text,role: role);
                                        }
                                      },
                                      validator: (value) {
                                        if(value!.isEmpty || value.isValidPassword())
                                    ...
                                    TextFormField(
                                      ...
                                      keyboardType: TextInputType.visiblePassword,
                                      validator: (value) {
                                        return value != passwordControllerS.text || value!.isEmpty? 'register_conPassword_error'.tr(context) : null;
                                      },
                                    ),
                                    SizedBox(
                                      height: MediaQuery.of(context).size.height/35,
                                    ...
                                    Row(
                                      children: [
                                         Text('please chose photo card',style:
                                          TextStyle(color: ColorManager.gery,fontSize: 15),),
                                        const Spacer(),
                                        IconButton(
                                          onPressed: (){
                                    ...
                                    TextFormField(
                                      ...
                                      controller: RegisterCubit.get(context).drivingLicenseController,
                                      keyboardType: TextInputType.number,
                                      textInputAction: TextInputAction.next,
                                      validator: (value) {
                                        if(value!.isEmpty)
