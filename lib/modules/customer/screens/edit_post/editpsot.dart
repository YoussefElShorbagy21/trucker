...
class EditPost extends StatelessWidget {
  ...
  EditPost({required this.id, required this.cid, required this.bid, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => HomeScreenCubit()
        ..getDetailsCategoryData(id, cid, bid)
        ..idCategory(cid)
        ..idBrand(bid),
                    ...
                    onPressed: () {
                      HomeScreenCubit.get(context).updatePostData(
                        name: HomeScreenCubit.get(context)
                            .editTextController
                            .text,
                        description: HomeScreenCubit.get(context)
                            .editDescriptionController
                            .text,
                        price: int.parse(HomeScreenCubit.get(context)
                            .editPriceController
                            .text),
                        id: id,
                        priceAfterDiscount: 400,
                        category: HomeScreenCubit.get(context)
                            .editIdCategoryControllerT,
                        brand:
                            HomeScreenCubit.get(context).editIdBrandControllerT,
                        locationFrom: HomeScreenCubit.get(context)
                            .editLocationFromControllerT,
                        locationTo: HomeScreenCubit.get(context)
                            .editLocationToControllerT,
                        userId: uid,
                      );
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(HomeScreenCubit.get(context)
                                    .detailsEquipment
                                    .imageCover),
                              ),
                            )),
                    ...
                    TextFormField(
                      controller:
                          HomeScreenCubit.get(context).editTextController,
                      validator: (value) {
                        if (value!.isEmpty) {
                      ...
                      decoration: InputDecoration(
                        ...
                        counterText:
                            '${HomeScreenCubit.get(context).editTextController.text.length} / 40',
                    ...
                    TextFormField(
                      controller:
                          HomeScreenCubit.get(context).editPriceController,
                    ...
                    InputField(
                      ...
                      note:
                          HomeScreenCubit.get(context).editCategoryControllerT,
                      widget: Row(
                        children: [
                          DropdownButton(
                    ...
                    InputField(
                      title: 'locationFrom'.tr(context),
                      note: HomeScreenCubit.get(context)
                          .editLocationFromControllerT,
                      widget: Row(
                        children: [
                          DropdownButton(
                    ...
                    TextFormField(
                      ...
                      controller: HomeScreenCubit.get(context)
                          .editDescriptionController,
                      decoration: InputDecoration(
                        hoverColor: const Color(0XFF408080),
                        contentPadding:
                        ...
                        counterText:
                            '${HomeScreenCubit.get(context).editDescriptionController.text.length} / 140',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                        ),
